...
app.layout = ddk.App(show_editor=False, # setting to True allows styling after build
    children=[
    ddk.Header([
    ...
    ddk.Block( # left-hand column
        ...
        children=[
                dcc.Tabs([
                    dcc.Tab(label='Map Filters', children=[
                    ...
                    dcc.Tab(label='About', children=[
                        ddk.Card(id='app-description', children=[
                            ...
                            dcc.Link('Data Source',
                                        href='https://open.canada.ca/',
                            ),
                            html.Br(),

                            dcc.Link('Available under open gov. license',
    ...
    ddk.Block( # right-hand column
        ...
        children=[
            ...
            ddk.Card( # Companies Dataframe Table
                children=[
                    ...
                    ddk.DataTable(id='companies-table',
                        columns=[{"name": i, "id": i} for i in df[['Company_Name', 'Project', '$_Amount']].columns],
                        fill_width=False,
            ...
            ddk.Card(width=50, # funding treemap
                children=[
