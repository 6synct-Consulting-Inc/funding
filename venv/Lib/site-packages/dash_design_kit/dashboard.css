...
/* IE 10/11 CSS patch (plotly/dash-design-kit#801) */
...
/* one graph */
.fullscreen--cb.fullscreenGraph .dash-graph:first-of-type:nth-last-of-type(1),
#modalContainer .modal--cb .dash-graph:first-of-type:nth-last-of-type(1) {
  height: 100%;
}

/* two graphs */
.fullscreen--cb.fullscreenGraph .dash-graph:first-of-type:nth-last-of-type(2),
.fullscreen--cb.fullscreenGraph .dash-graph:first-of-type:nth-last-of-type(2) ~ .dash-graph,
...
/* three graphs */
.fullscreen--cb.fullscreenGraph .dash-graph:first-of-type:nth-last-of-type(3),
